    ...
    <>
      ...
      <section id="about-section" className="bg-gray-200 flex flex-col items-center justify-center px-8 sm:px-8 py-6 sm:py-12 overflow-hidden">
        ...
        <div className="text-center flex flex-col items-center mt-10 sm:mt-20">
          <Link to="/products/goblin-jersey" className="bg-gray-100 hover:bg-gray-300 text-gray-700 font-bold py-2 px-4 sm:py-3 sm:px-6 rounded-full shadow-lg transition-transform transform hover:scale-105">
            Shop the Collection
          </Link>
        </div>
      </section>
