        ...
        <section class="bg-white">
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div class="mx-auto max-w-screen-sm text-center">
                    ...
                    <a href="/home" class="inline-flex bg-green-700 text-white hover:bg-green-900 font-medium rounded-lg text-sm px-5 py-2.5 text-center mt-4">Back to Homepage</a>
                </div>   
            </div>
        </section>
    );
